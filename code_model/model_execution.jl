...
SW_layer = WaterLayer(200.0, 37.95, 13.18)
LIW_layer = WaterLayer(600.0, 38.54, 13.38)
WMDW_layer = WaterLayer(grid.Lz, 38.41, 12.71)
test_layer = WaterLayer(grid.Lz, 35.0, 20.01)
...
model_arguments = [Dict(:u₁₀=>30.0, :dTdz=>0.00)  
                                          ]
#

simulation_arguments= [Dict(:t=>40minutes)]
